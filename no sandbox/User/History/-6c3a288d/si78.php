...
class SampleDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('users')->insert([
            ['id' => 1, 'username' => 'johndoe', 'univEmail' => 'johndoe@example.com', 'password' => Hash::make('password123'), 'lastName' => 'Doe', 'firstName' => 'John', 'userPicture' => 'profile1.jpg', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 2, 'username' => 'janedoe', 'univEmail' => 'janedoe@example.com', 'password' => Hash::make('password123'), 'lastName' => 'Doe', 'firstName' => 'Jane', 'userPicture' => 'profile2.jpg', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 3, 'username' => 'michael', 'univEmail' => 'michael@example.com', 'password' => Hash::make('password123'), 'lastName' => 'Smith', 'firstName' => 'Michael', 'userPicture' => 'profile3.jpg', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 4, 'username' => 'emily', 'univEmail' => 'emily@example.com', 'password' => Hash::make('password123'), 'lastName' => 'Johnson', 'firstName' => 'Emily', 'userPicture' => 'profile4.jpg', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 5, 'username' => 'david', 'univEmail' => 'david@example.com', 'password' => Hash::make('password123'), 'lastName' => 'Brown', 'firstName' => 'David', 'userPicture' => 'profile5.jpg', 'created_at' => now(), 'updated_at' => now()],
        ]);
