    ...
    <div class="navbar-content">
        ...
        <div class="auth-buttons">
            ...
            @else
                ...
                <!-- Image de profil cliquable et l'icone à côter-->
                {{-- <div>
                    <div class="profile-menu" style="position: relative;">
                        <img src="{{ asset('images/' . (optional(Auth::user())->userPicture ?? 'profile.png')) }}" alt="Profile"
                            class="rounded-full" style="width: 40px; height: 40px; object-fit: cover; cursor: pointer;border-radius: 50%;"
                            onclick="document.getElementById('userModal').style.display = 'block';">
                    </div>
                    <!-- down arrow -->
                </div> --}}
                <!-- Image de profil cliquable et l'icône à côté -->
                <div style="display: flex; align-items: center; cursor: pointer;"
                    onclick="document.getElementById('userModal').style.display = 'block';">
                    <div class="profile-menu" style="position: relative;">
                        <img src="{{ asset('images/' . (optional(Auth::user())->userPicture ?? 'profile.png')) }}"
