...
Route::prefix('user')->name('user.')->middleware('auth')->group(function() {
    ...
    // Route::get('/questions/ask/askform', [QuestionController::class, 'questionForm'])->name('questions.askform');
    Route::get('/questions/ask/askform',function () {
        return 'test';
    })->name('questions.askform');
