...
@section('content')
   ...
   <div class="askbutton text-end p-3">
    <a href="{{ route('user.questions.questionform') }}" class="btn btn-primary rounded-circle shadow" style="width: 50px; height: 50px; display: inline-flex; align-items: center; justify-content: center;">
        <i class="bi bi-plus-lg">poser une question</i>
    </a>
</div>
        ...
        @foreach ($questions as $question)
            <div class="post-card">
                ...
                <div class="post-footer">
                    ...
                    <span>⬆️
                        {{ $question->reponses->sum(function ($reponse) {return $reponse->votes->sum('nbreVote');}) }}</span>
                </div>
            </div>
        @endforeach
    </div>
