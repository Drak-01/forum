...
@section('content')
    ...
    <div class="posts-container">
        @foreach ($questions as $question)
            <a href="{{ route('questions.show', $question) }}" class="post-card">
                <div class="post-header">
                ...
                <div class="post-footer">
                    ...
                    {{-- <span>⬆️
                        {{ $question->reponses->sum(function ($reponse) {return $reponse->votes->sum('nbreVote');}) }}
                    </span> --}}
                    <span>⬆️
                        {{ $question->reponses->isNotEmpty() ? $question->reponses->sum(function ($reponse) {
                            return $reponse->votes->isNotEmpty() ? $reponse->votes->sum('nbreVote') : 0;
                        }) : 0 }}
                    </span>
