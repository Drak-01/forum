...
<style>
    ...
    .collectives-container {
        position: relative;
        max-height: none; /* Hauteur par défaut */
        overflow-y: hidden; /* Pas de défilement initial */
    }
    ...
    .collectives-container.scroll-active {
        max-height: 500px; /* Hauteur maximale avant défilement */
        overflow-y: auto;
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const maxHeightBeforeScroll = 500; // Seuil en pixels (ajustez selon vos besoins)
        ...
        setTimeout(() => {
            if (collectivesList.scrollHeight > maxHeightBeforeScroll) {
                ...
                container.style.maskImage = 'linear-gradient(to bottom, transparent 0, black 20px, black calc(100% - 20px), transparent 100%)';
                container.style.webkitMaskImage = 'linear-gradient(to bottom, transparent 0, black 20px, black calc(100% - 20px), transparent 100%)';
            }
        }, 100);
    });
    </script>